...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 427624758857244169L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.social.ecom.order.avro\",\"fields\":[{\"name\":\"productId\",\"type\":\"int\"},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public OrderItem(java.lang.Integer productId, java.lang.Integer quantity, java.lang.Float price) {
   ...
   */
  public static com.social.ecom.order.avro.OrderItem.Builder newBuilder() {
    return new com.social.ecom.order.avro.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.social.ecom.order.avro.OrderItem.Builder newBuilder(com.social.ecom.order.avro.OrderItem.Builder other) {
    if (other == null) {
      return new com.social.ecom.order.avro.OrderItem.Builder();
    } else {
      return new com.social.ecom.order.avro.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.social.ecom.order.avro.OrderItem.Builder newBuilder(com.social.ecom.order.avro.OrderItem other) {
    if (other == null) {
      return new com.social.ecom.order.avro.OrderItem.Builder();
    } else {
      return new com.social.ecom.order.avro.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.social.ecom.order.avro.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.social.ecom.order.avro.OrderItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder setProductId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.social.ecom.order.avro.OrderItem.Builder clearPrice() {
